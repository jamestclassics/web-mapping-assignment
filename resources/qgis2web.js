...
map.getView().fit([-867175.123877, 7142351.690323, -697198.789045, 7255053.390592], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Pubs in Monaghan</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (32 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Pubs and Bars in County Monaghan';
            }
